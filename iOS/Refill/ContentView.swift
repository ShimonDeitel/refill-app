...
struct ContentView: View {
    @EnvironmentObject var store: RefillStore
    @EnvironmentObject var purchases: PurchaseManager

    @State private var showingAdd = false
    @State private var showingSettings = false
    @State private var showingPaywall = false
    @State private var editingEntry: RefillEntry?
    ...
    private func entryRow(_ entry: RefillEntry) -> some View {
        HStack {
...
struct AddEntrySheet: View {
    ...
    init(existing: RefillEntry? = nil, onSave: @escaping (String, Double) -> Void) {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(existing == nil ? "Add Refill" : "Edit Refill")
